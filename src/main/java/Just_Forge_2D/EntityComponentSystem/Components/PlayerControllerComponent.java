...
public class PlayerControllerComponent extends Component
{
    ...
    public void checkOnGround()
    {
        ...
        RayCastInfo info = Forge.getPhysicsSystem().rayCast(gameObject, raycastBegin, raycastEnd);
        ...
        RayCastInfo info2 = Forge.getPhysicsSystem().rayCast(gameObject, raycast2Begin, raycast2End);
