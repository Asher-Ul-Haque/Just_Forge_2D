...
public class Logger
{
    ...
    // - - -Log file path
    private static final Path LOG_FILE_PATH = Paths.get("logs", LocalDateTime.now().toString() + ".justForgeLog");
    ...
    public static void FORGE_LOG_FATAL(Object... ARGS)
    {
        ...
        if (!EditorSystemManager.isRelease) System.out.println(ANSI_RESET + ANSI_RED_BG + message + ANSI_RESET);
        writeToFile(message);
    }
    ...
    public static void FORGE_LOG_ERROR(Object... ARGS)
    {
        ...
        if (!EditorSystemManager.isRelease) System.out.println(ANSI_RED + message + ANSI_RESET);
        writeToFile(message);
    }
    ...
    public static void FORGE_LOG_WARNING(Object... ARGS)
    {
        ...
        if (!EditorSystemManager.isRelease) System.out.println(ANSI_PASTEL_RED + message + ANSI_RESET);
        writeToFile(message);
    }
    ...
    public static void FORGE_LOG_DEBUG(Object... ARGS)
    {
        ...
        if (!EditorSystemManager.isRelease) System.out.println(ANSI_BLUE + message + ANSI_RESET);
        writeToFile(message);
    }
    ...
    public static void FORGE_LOG_TRACE(Object... ARGS)
    {
        ...
        if (!EditorSystemManager.isRelease) System.out.println(ANSI_PURPLE + message + ANSI_RESET);
        writeToFile(message);
    }
    ...
    public static void FORGE_LOG_INFO(Object... ARGS)
    {
        ...
        if (!EditorSystemManager.isRelease) System.out.println(ANSI_GREEN + message + ANSI_RESET);
        writeToFile(message);
    }
