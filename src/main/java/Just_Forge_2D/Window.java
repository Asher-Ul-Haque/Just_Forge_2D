...
public class Window implements Observer
{
    ...
    private int width = DefaultValues.DEFAULT_WINDOW_WIDTH;
    private int height= DefaultValues.DEFAULT_WINDOW_HEIGHT;
    ...
    private Window()
    {
        float targetAspectRatio = DefaultValues.DEFAULT_ASPECT_RATIO;
